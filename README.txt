...
Herramienta en **Python** para trabajar con **semillas BIP-39** y direcciones de Bitcoin.  
Incluye múltiples modos para generar, verificar y recuperar semillas de forma sencilla e interactiva.  
